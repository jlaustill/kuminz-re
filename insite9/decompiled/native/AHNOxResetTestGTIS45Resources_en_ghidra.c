/*
 * Decompiled from: AHNOxResetTestGTIS45Resources_en.dll
 * Using Ghidra 11.4.1
 */

// Function: FUN_67601000 at 67601000

undefined4 FUN_67601000(void)
...
// Function: __CRT_INIT@12 at 67601008
...

{
  ...
  if (param_2 == 1) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        __RTC_Initialize();
        DAT_676098d8 = GetCommandLineA();
        DAT_67608b24 = ___crtGetEnvironmentStringsA();
        iVar1 = __ioinit();
        if (-1 < iVar1) {
          iVar1 = __setargv();
          if (((-1 < iVar1) && (iVar1 = __setenvp(), -1 < iVar1)) &&
             (iVar1 = __cinit(0), iVar1 == 0)) {
            DAT_67608b20 = DAT_67608b20 + 1;
            return 1;
          }
          __ioterm();
        }
    ...
    if (_Ptd != (_ptiddata)0x0) {
      uVar4 = DAT_67608000;
      p_Var5 = _Ptd;
      pcVar2 = (code *)DecodePointer(DAT_67608b3c);
...
// Function: FUN_676010e1 at 676010e1

void FUN_676010e1(void)

{
  int unaff_EBP;
  int unaff_EDI;
  
  if ((*(int *)(unaff_EBP + 0x10) == unaff_EDI) && (DAT_67608000 != -1)) {
    __mtterm();
  }
  return;
}
...
// Function: ___DllMainCRTStartup at 6760116c

/* WARNING: Function: __SEH_prolog4 replaced with injection: SEH_prolog4 */
/* WARNING: Function: __SEH_epilog4 replaced with injection: EH_epilog3 */
/* WARNING: Removing unreachable block (ram,0x676011fe) */
/* WARNING: Removing unreachable block (ram,0x676011ab) */
/* WARNING: Removing unreachable block (ram,0x6760122b) */
/* Library Function - Single Match
...
// Function: FUN_67601285 at 67601285

void FUN_67601285(void)
...
// Function: ___set_flsgetvalue at 67601297
...

{
  ...
  lpTlsValue = TlsGetValue(DAT_67608004);
  if (lpTlsValue == (LPVOID)0x0) {
    lpTlsValue = DecodePointer(DAT_67608b38);
    TlsSetValue(DAT_67608004,lpTlsValue);
  }
  return lpTlsValue;
}
...

{
  ...
  if (DAT_67608000 != -1) {
    iVar2 = DAT_67608000;
    pcVar1 = (code *)DecodePointer(DAT_67608b40);
    (*pcVar1)(iVar2);
    DAT_67608000 = -1;
  }
  if (DAT_67608004 != 0xffffffff) {
    TlsFree(DAT_67608004);
    DAT_67608004 = 0xffffffff;
  }
  __mtdeletelocks();
  return;
}
...
// Function: __initptd at 67601308
...

{
  ...
  *(undefined1 *)((int)(_Ptd->_setloc_data)._cachein + 0x93) = 0x43;
  ...
  if (_Locale == (pthreadlocinfo)0x0) {
    _Ptd->ptlocinfo = (pthreadlocinfo)PTR_DAT_676083b8;
  }
...
// Function: FUN_676013aa at 676013aa

void FUN_676013aa(void)
...
// Function: FUN_676013b3 at 676013b3

void FUN_676013b3(void)
...
// Function: __getptd_noexit at 676013bc
...

{
  ...
  if (_Ptd == (_ptiddata)0x0) {
    ...
    if (_Ptd != (_ptiddata)0x0) {
      uVar4 = DAT_67608000;
      p_Var5 = _Ptd;
      pcVar1 = (code *)DecodePointer(DAT_67608b3c);
...
// Function: __freefls@4 at 6760144f
...

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (*(undefined **)((int)param_1 + 0x5c) != &DAT_67606188) {
    ...
    if (pLVar1 != (LONG *)0x0) {
      ...
      if ((LVar2 == 0) && (pLVar1 != (LONG *)&DAT_676083c0)) {
        _free(pLVar1);
      }
    }
    FUN_67601569();
    ...
    if (pLVar1 != (LONG *)0x0) {
      ...
      if (((pLVar1 != (LONG *)PTR_DAT_676083b8) && (pLVar1 != (LONG *)&DAT_676082e0)) &&
         (*pLVar1 == 0)) {
...
// Function: FUN_67601569 at 67601569

void FUN_67601569(void)
...
// Function: FUN_67601575 at 67601575

void FUN_67601575(void)
...
// Function: __freeptd at 6760157e
...

{
  ...
  if (DAT_67608000 != -1) {
    if ((_Ptd == (_ptiddata)0x0) && (pvVar1 = TlsGetValue(DAT_67608004), pvVar1 != (LPVOID)0x0)) {
      iVar3 = DAT_67608000;
      pcVar2 = (code *)TlsGetValue(DAT_67608004);
  ...
  if (DAT_67608004 != 0xffffffff) {
    TlsSetValue(DAT_67608004,(LPVOID)0x0);
  }
  return;
}
...

{
  ...
  DAT_67608b34 = GetProcAddress(hModule,"FlsAlloc");
  DAT_67608b38 = GetProcAddress(hModule,"FlsGetValue");
  DAT_67608b3c = GetProcAddress(hModule,"FlsSetValue");
  DAT_67608b40 = GetProcAddress(hModule,"FlsFree");
  if ((((DAT_67608b34 == (FARPROC)0x0) || (DAT_67608b38 == (FARPROC)0x0)) ||
      (DAT_67608b3c == (FARPROC)0x0)) || (DAT_67608b40 == (FARPROC)0x0)) {
    DAT_67608b38 = TlsGetValue_exref;
    DAT_67608b34 = (FARPROC)&LAB_6760128e;
    DAT_67608b3c = TlsSetValue_exref;
    DAT_67608b40 = TlsFree_exref;
  }
  DAT_67608004 = TlsAlloc();
  if ((DAT_67608004 != 0xffffffff) && (BVar1 = TlsSetValue(DAT_67608004,DAT_67608b38), BVar1 != 0))
  {
    __init_pointers();
    DAT_67608b34 = (FARPROC)EncodePointer(DAT_67608b34);
    DAT_67608b38 = (FARPROC)EncodePointer(DAT_67608b38);
    DAT_67608b3c = (FARPROC)EncodePointer(DAT_67608b3c);
    DAT_67608b40 = (FARPROC)EncodePointer(DAT_67608b40);
    iVar2 = __mtinitlocks();
    if (iVar2 != 0) {
      pcVar5 = __freefls_4;
      pcVar3 = (code *)DecodePointer(DAT_67608b34);
      DAT_67608000 = (*pcVar3)(pcVar5);
      if ((DAT_67608000 != -1) && (_Ptd = (_ptiddata)__calloc_crt(1,0x214), _Ptd != (_ptiddata)0x0))
      {
        iVar2 = DAT_67608000;
        p_Var6 = _Ptd;
        pcVar3 = (code *)DecodePointer(DAT_67608b3c);
...

{
  ...
  if (_Memory != (void *)0x0) {
    BVar1 = HeapFree(DAT_67608c88,0,_Memory);
    if (BVar1 == 0) {
      piVar2 = __errno();
      DVar3 = GetLastError();
...
// Function: __malloc_crt at 676017a1
...

{
  ...
  while( true ) {
    ...
    if (DAT_67608b44 == 0) break;
    Sleep(dwMilliseconds);
    dwMilliseconds = dwMilliseconds + 1000;
    if (DAT_67608b44 < dwMilliseconds) {
...
// Function: __calloc_crt at 676017e6
...
// Function: __realloc_crt at 67601832
...
// Function: ___crtCorExitProcess at 67601880
...
// Function: ___crtExitProcess at 676018ab
...
// Function: FUN_676018c3 at 676018c3

void FUN_676018c3(void)
...
// Function: FUN_676018cc at 676018cc

void FUN_676018cc(void)
...
// Function: __init_pointers at 676018d5
...
// Function: __initterm_e at 67601908
...

{
  ...
  if ((DAT_676098d0 != (code *)0x0) &&
     (BVar1 = __IsNonwritableInCurrentImage((PBYTE)&DAT_676098d0), BVar1 != 0)) {
    (*DAT_676098d0)(param_1);
  }
  __initp_misc_cfltcvt_tab();
  iVar2 = __initterm_e((undefined4 *)&DAT_676060e8,(undefined4 *)&DAT_676060f8);
  if (iVar2 == 0) {
    _atexit((_func_4879 *)&LAB_676021cc);
    puVar3 = &DAT_676060e0;
    do {
      ...
      puVar3 = puVar3 + 1;
    } while (puVar3 < &DAT_676060e4);
    if ((DAT_676098d4 != (code *)0x0) &&
       (BVar1 = __IsNonwritableInCurrentImage((PBYTE)&DAT_676098d4), BVar1 != 0)) {
      (*DAT_676098d4)(0,2,0);
    }
    iVar2 = 0;
  }
...
// Function: doexit at 676019c3

/* WARNING: Function: __SEH_prolog4 replaced with injection: SEH_prolog4 */
/* WARNING: Function: __SEH_epilog4 replaced with injection: EH_epilog3 */
/* WARNING: Removing unreachable block (ram,0x67601af4) */
/* Library Function - Single Match
    _doexit
...

{
  ...
  if (DAT_67608b78 != 1) {
    DAT_67608b74 = 1;
    DAT_67608b70 = (undefined1)param_3;
    if (param_2 == 0) {
      piVar1 = (int *)DecodePointer(DAT_676098c8);
      if (piVar1 != (int *)0x0) {
        piVar2 = (int *)DecodePointer(DAT_676098c4);
        local_34 = piVar1;
        local_2c = piVar2;
        local_28 = piVar1;
        while (piVar2 = piVar2 + -1, piVar1 <= piVar2) {
          ...
          if (*piVar2 != iVar3) {
            ...
            *piVar2 = iVar3;
            (*pcVar4)();
            piVar5 = (int *)DecodePointer(DAT_676098c8);
            piVar6 = (int *)DecodePointer(DAT_676098c4);
      ...
      for (local_20 = &DAT_676060fc; local_20 < &DAT_67606100; local_20 = local_20 + 1) {
        if ((code *)*local_20 != (code *)0x0) {
          (*(code *)*local_20)();
        }
      }
    }
    for (local_24 = &DAT_67606104; local_24 < &DAT_67606108; local_24 = local_24 + 1) {
...
// Function: FUN_67601aee at 67601aee

void FUN_67601aee(void)
...
// Function: __amsg_exit at 67601b28
...

{
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    if (pvVar1 < (void *)((int)pvVar1 + 0x800U)) {
      ...
      do {
        ...
        *(undefined1 *)(iVar2 + 0x2f) = 0;
        uVar10 = iVar2 + 0x3b;
        iVar2 = iVar2 + 0x40;
      } while (uVar10 < (int)DAT_676097c0 + 0x800U);
    }
    if ((local_50.cbReserved2 != 0) && ((UINT *)local_50.lpReserved2 != (UINT *)0x0)) {
      ...
      UVar7 = UVar6;
      if ((int)DAT_676097a0 < (int)UVar6) {
        piVar9 = &DAT_676097c4;
        do {
          pvVar1 = __calloc_crt(0x20,0x40);
          UVar7 = DAT_676097a0;
          if (pvVar1 == (void *)0x0) break;
          DAT_676097a0 = DAT_676097a0 + 0x20;
          *piVar9 = (int)pvVar1;
          if (pvVar1 < (void *)((int)pvVar1 + 0x800U)) {
            iVar2 = (int)pvVar1 + 5;
            do {
          ...
          piVar9 = piVar9 + 1;
          UVar7 = UVar6;
        } while ((int)DAT_676097a0 < (int)UVar6);
      }
      uVar10 = 0;
      if (0 < (int)UVar7) {
        do {
          ...
          if ((((pvVar5 != (HANDLE)0xffffffff) && (pvVar5 != (HANDLE)0xfffffffe)) &&
            ...
            puVar8 = (undefined4 *)((uVar10 & 0x1f) * 0x40 + (int)(&DAT_676097c0)[(int)uVar10 >> 5])
            ;
    ...
    iVar2 = 0;
    do {
      piVar9 = (int *)(iVar2 * 0x40 + (int)DAT_676097c0);
...

{
  ...
  do {
    ...
    puVar3 = puVar3 + 1;
  } while ((int)puVar3 < 0x676098c0);
  return;
}



// Function: __setenvp at 67601dde
...
// Function: parse_cmdline at 67601eba
...
// Function: __setargv at 67602054
...

{
  ...
  DAT_67608c84 = 0;
  GetModuleFileNameA((HMODULE)0x0,&DAT_67608b80,0x104);
  _DAT_67608b68 = &DAT_67608b80;
  if ((DAT_676098d8 == (char *)0x0) || (local_8 = DAT_676098d8, *DAT_676098d8 == '\0')) {
    local_8 = &DAT_67608b80;
  }
  ...
  if ((local_c < 0x3fffffff) && (local_10 != 0xffffffff)) {
    ...
    if ((local_10 <= _Size) &&
      ...
      _DAT_67608b4c = local_c - 1;
      _DAT_67608b50 = puVar2;
      return 0;
    }
  }
  return -1;
...
// Function: ___crtGetEnvironmentStringsA at 6760210f
...
// Function: __RTC_Initialize at 676021a6

/* WARNING: Removing unreachable block (ram,0x676021ba) */
/* WARNING: Removing unreachable block (ram,0x676021c0) */
/* WARNING: Removing unreachable block (ram,0x676021c2) */
/* Library Function - Single Match
    __RTC_Initialize
...
// Function: __heap_init at 676021f2
...
{
  DAT_67608c88 = HeapCreate(0,0x1000,0);
  return (uint)(DAT_67608c88 != (HANDLE)0x0);
}



// Function: __heap_term at 67602210
...
{
  HeapDestroy(DAT_67608c88);
  DAT_67608c88 = (HANDLE)0x0;
  return;
}



// Function: __SEH_prolog4 at 67602230
...

{
  ...
  *(uint *)((int)auStack_1c + iVar1 + 4) = DAT_67608a80 ^ (uint)&param_2;
...
// Function: __SEH_epilog4 at 67602275
...
// Function: __except_handler4 at 67602290
...

{
  ...
  piVar5 = (int *)(*(uint *)((int)param_2 + 8) ^ DAT_67608a80);
  local_5 = '\0';
  local_10 = 1;
    ...
    *(PEXCEPTION_RECORD **)((int)param_2 + -4) = &local_1c;
    ...
    do {
      ...
      if ((undefined *)piVar5[(int)pvVar4 * 3 + 5] != (undefined *)0x0) {
        ...
        if (0 < iVar2) {
          if (((param_1->ExceptionCode == 0xe06d7363) && (DAT_6760979c != (code *)0x0)) &&
             (BVar3 = __IsNonwritableInCurrentImage((PBYTE)&DAT_6760979c), BVar3 != 0)) {
            (*DAT_6760979c)(param_1,1);
          }
          _EH4_GlobalUnwind2(param_2,param_1);
          if (*(PVOID *)((int)param_2 + 0xc) != pvVar4) {
            _EH4_LocalUnwind((int)param_2,(uint)pvVar4,iVar1,&DAT_67608a80);
          }
...
LAB_676023ff:
    ...
    _EH4_LocalUnwind((int)pvVar4,0xfffffffe,iVar1,&DAT_67608a80);
  }
LAB_67602338:
  if (*piVar5 != -2) {
    __security_check_cookie(piVar5[1] + iVar1 ^ *(uint *)(*piVar5 + iVar1));
...
// Function: __XcptFilter at 6760241f
...
// Function: ___CppXcptFilter at 67602569
...
// Function: ___security_init_cookie at 67602589
...

{
  ...
  if ((DAT_67608a80 == 0xbb40e64e) || ((DAT_67608a80 & 0xffff0000) == 0)) {
    ...
    DAT_67608a80 = uVar4 ^ DVar1 ^ DVar2 ^ DVar3 ^ local_14.s.HighPart ^ local_14.s.LowPart;
    if (DAT_67608a80 == 0xbb40e64e) {
      DAT_67608a80 = 0xbb40e64f;
    }
    else if ((DAT_67608a80 & 0xffff0000) == 0) {
      DAT_67608a80 = DAT_67608a80 | (DAT_67608a80 | 0x4711) << 0x10;
    }
    DAT_67608a84 = ~DAT_67608a80;
  }
  else {
    DAT_67608a84 = ~DAT_67608a80;
  }
...
// Function: __mtinitlocks at 67602624
...

{
  ...
  puVar3 = &DAT_67608c90;
  do {
    if ((&DAT_67608054)[iVar2 * 2] == 1) {
      (&DAT_67608050)[iVar2 * 2] = puVar3;
      puVar3 = puVar3 + 0x18;
      BVar1 = InitializeCriticalSectionAndSpinCount
                        ((LPCRITICAL_SECTION)(&DAT_67608050)[iVar2 * 2],4000);
      if (BVar1 == 0) {
        (&DAT_67608050)[iVar2 * 2] = 0;
        return 0;
      }
    }
    iVar2 = iVar2 + 1;
...
// Function: __mtdeletelocks at 6760266e
...
// Function: FUN_676026c5 at 676026c5

void __cdecl FUN_676026c5(int param_1)

{
  LeaveCriticalSection((LPCRITICAL_SECTION)(&DAT_67608050)[param_1 * 2]);
  return;
}



// Function: __mtinitlocknum at 676026dc
...

{
  ...
  piVar1 = &DAT_67608050 + _LockNum * 2;
  if (*piVar1 == 0) {
...
// Function: FUN_67602795 at 67602795

void FUN_67602795(void)
...

{
  ...
  if ((&DAT_67608050)[_File * 2] == 0) {
    iVar1 = __mtinitlocknum(_File);
    if (iVar1 == 0) {
      __amsg_exit(0x11);
    }
  }
  EnterCriticalSection((LPCRITICAL_SECTION)(&DAT_67608050)[_File * 2]);
  return;
}



// Function: ___addlocaleref at 676027d1
...

{
  ...
  param_1 = (LONG *)0x6;
  do {
    if (((undefined *)pLVar2[-2] != &DAT_67608170) && ((LONG *)*pLVar2 != (LONG *)0x0)) {
...
// Function: ___removelocaleref at 67602860
...
// Function: ___freetlocinfo at 676028f9
...

{
  ...
  if ((((*(undefined ***)((int)param_1 + 0xbc) != (undefined **)0x0) &&
       (*(undefined ***)((int)param_1 + 0xbc) != &PTR_DAT_67608a98)) &&
  ...
  if ((ppuVar2 != &PTR_DAT_67608178) && (ppuVar2[0x2d] == (undefined *)0x0)) {
  ...
  param_1 = (void *)0x6;
  do {
    if ((((undefined *)puVar3[-2] != &DAT_67608170) &&
...
// Function: __updatetlocinfoEx_nolock at 67602a44
...
// Function: ___updatetlocinfo at 67602a91
...

{
  ...
  p_Var1 = __getptd();
  if (((p_Var1->_ownlocale & DAT_67608aec) == 0) || (p_Var1->ptlocinfo == (pthreadlocinfo)0x0)) {
    __lock(0xc);
    ptVar2 = (pthreadlocinfo)&p_Var1->ptlocinfo;
    __updatetlocinfoEx_nolock((undefined4 *)ptVar2,(LONG *)PTR_DAT_676083b8);
    FUN_67602afe();
  }
  else {
    p_Var1 = __getptd();
...
// Function: FUN_67602afe at 67602afe

void FUN_67602afe(void)
...

{
  ...
  *(undefined4 *)(in_EAX + 0x18) = 0;
  ...
  iVar2 = 0x101;
  do {
    *puVar1 = puVar1[(int)&DAT_676083c0 - in_EAX];
    puVar1 = puVar1 + 1;
    iVar2 = iVar2 + -1;
  } while (iVar2 != 0);
...
// Function: setSBUpLow at 67602b9d
...

{
  ...
  local_8 = DAT_67608a80 ^ (uint)&stack0xfffffffc;
...
// Function: ___updatetmbcinfo at 67602d2d
...

{
  ...
  if (((p_Var1->_ownlocale & DAT_67608aec) == 0) || (p_Var1->ptlocinfo == (pthreadlocinfo)0x0)) {
    ...
    if (lpAddend != (pthreadmbcinfo)PTR_DAT_676087e8) {
      if (lpAddend != (pthreadmbcinfo)0x0) {
        LVar2 = InterlockedDecrement(&lpAddend->refcount);
        if ((LVar2 == 0) && (lpAddend != (pthreadmbcinfo)&DAT_676083c0)) {
          _free(lpAddend);
        }
      }
      p_Var1->ptmbcinfo = (pthreadmbcinfo)PTR_DAT_676087e8;
      lpAddend = (pthreadmbcinfo)PTR_DAT_676087e8;
      InterlockedIncrement((LONG *)PTR_DAT_676087e8);
    }
    FUN_67602dc8();
  }
  else {
...
// Function: FUN_67602dc8 at 67602dc8

void FUN_67602dc8(void)
...
// Function: _LocaleUpdate at 67602dd1
...

{
  ...
  if (param_1 == (localeinfo_struct *)0x0) {
    ...
    *(pthreadmbcinfo *)(this + 4) = p_Var2->ptmbcinfo;
    if ((*(undefined **)this != PTR_DAT_676083b8) && ((p_Var2->_ownlocale & DAT_67608aec) == 0)) {
      ptVar3 = ___updatetlocinfo();
      *(pthreadlocinfo *)this = ptVar3;
    }
    if ((*(undefined **)(this + 4) != PTR_DAT_676087e8) &&
       ((*(uint *)(*(int *)(this + 8) + 0x70) & DAT_67608aec) == 0)) {
...
// Function: getSystemCP at 67602e58
...
// Function: __setmbcp_nolock at 67602ed4
...

{
  ...
  if (uVar4 != 0) {
    ...
    uVar5 = 0;
LAB_67602f12:
    if (*(uint *)((int)&DAT_676087f0 + uVar5) != uVar4) goto code_r0x67602f1e;
    _memset((void *)(param_2 + 0x1c),0,0x101);
    local_24 = 0;
    pbVar8 = &DAT_67608800 + (int)local_20 * 0x30;
    local_20 = pbVar8;
    do {
      for (; (*pbVar8 != 0 && (bVar3 = pbVar8[1], bVar3 != 0)); pbVar8 = pbVar8 + 2) {
        for (uVar5 = (uint)*pbVar8; uVar5 <= bVar3; uVar5 = uVar5 + 1) {
          ...
          *pbVar2 = *pbVar2 | *(byte *)(local_24 + 0x676087ec);
          bVar3 = pbVar8[1];
        }
      }
      local_24 = local_24 + 1;
    ...
    *(int *)(param_2 + 0xc) = iVar10;
    ...
    puVar9 = (undefined2 *)(&DAT_676087f4 + extraout_ECX);
    iVar10 = 6;
    do {
      *puVar7 = *puVar9;
      puVar9 = puVar9 + 1;
...
code_r0x67602f1e:
  ...
  uVar5 = uVar5 + 0x30;
  if (0xef < uVar5) goto code_r0x67602f2b;
  goto LAB_67602f12;
code_r0x67602f2b:
  if (((uVar4 == 65000) || (uVar4 == 0xfde9)) ||
     (BVar6 = IsValidCodePage(uVar4 & 0xffff), BVar6 == 0)) goto LAB_676030ae;
...
LAB_67603046:
  ...
  if (DAT_67608de0 == 0) goto LAB_676030ae;
  goto LAB_67602eff;
}



// Function: __setmbcp at 676030bd
  ...
  if (iVar2 == ptVar3->mbcodepage) {
    ...
    if (ptVar3 != (pthreadmbcinfo)0x0) {
      ...
      if (local_24 == 0) {
        ...
        if ((LVar4 == 0) && (p_Var1->ptmbcinfo != (pthreadmbcinfo)&DAT_676083c0)) {
          _free(p_Var1->ptmbcinfo);
        }
        p_Var1->ptmbcinfo = ptVar3;
        InterlockedIncrement((LONG *)ptVar3);
        if (((p_Var1->_ownlocale & 2) == 0) && (((byte)DAT_67608aec & 1) == 0)) {
          __lock(0xd);
          _DAT_67608df0 = ptVar3->mbcodepage;
          _DAT_67608df4 = ptVar3->ismbcodepage;
          _DAT_67608df8 = *(undefined4 *)ptVar3->mbulinfo;
          for (iVar2 = 0; iVar2 < 5; iVar2 = iVar2 + 1) {
            (&DAT_67608de4)[iVar2] = ptVar3->mbulinfo[iVar2 + 2];
          }
          for (iVar2 = 0; iVar2 < 0x101; iVar2 = iVar2 + 1) {
            (&DAT_676085e0)[iVar2] = ptVar3->mbctype[iVar2 + 4];
          }
          for (iVar2 = 0; iVar2 < 0x100; iVar2 = iVar2 + 1) {
            (&DAT_676086e8)[iVar2] = ptVar3->mbcasemap[iVar2 + 4];
          }
          LVar4 = InterlockedDecrement((LONG *)PTR_DAT_676087e8);
          if ((LVar4 == 0) && (PTR_DAT_676087e8 != &DAT_676083c0)) {
            _free(PTR_DAT_676087e8);
          }
          PTR_DAT_676087e8 = (undefined *)ptVar3;
          InterlockedIncrement((LONG *)ptVar3);
          FUN_6760321e();
        }
      }
      else if (local_24 == -1) {
        if (ptVar3 != (pthreadmbcinfo)&DAT_676083c0) {
          _free(ptVar3);
        }
        piVar5 = __errno();
        *piVar5 = 0x16;
...
// Function: FUN_6760321e at 6760321e

void FUN_6760321e(void)
...
// Function: ___initmbctable at 67603257
...
// Function: __get_errno_from_oserr at 67603275
...

{
  ...
  uVar1 = 0;
  do {
    if (param_1 == (&DAT_676088e0)[uVar1 * 2]) {
      return *(int *)(uVar1 * 8 + 0x676088e4);
    }
    uVar1 = uVar1 + 1;
  } while (uVar1 < 0x2d);
...

{
  ...
  if (_Size < 0xffffffe1) {
    do {
      ...
      pvVar1 = HeapAlloc(DAT_67608c88,0,dwBytes);
      if (pvVar1 != (LPVOID)0x0) {
        return pvVar1;
      }
      if (DAT_67609458 == 0) {
...
// Function: __calloc_impl at 6760335e
...

{
  ...
  do {
    ...
    if ((dwBytes < 0xffffffe1) &&
       (pvVar2 = HeapAlloc(DAT_67608c88,8,dwBytes), pvVar2 != (LPVOID)0x0)) {
      return pvVar2;
    }
    if (DAT_67609458 == 0) {
...

{
  ...
  if (_NewSize == 0) {
    ...
    do {
      ...
      pvVar2 = HeapReAlloc(DAT_67608c88,0,_Memory,_NewSize);
...
// Function: FUN_676034c6 at 676034c6

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_676034c6(void)

{
  _DAT_67608dfc = EncodePointer(&LAB_6760348d);
  return;
}



// Function: __initp_misc_winsig at 676034d7
...
{
  DAT_67608e00 = param_1;
  DAT_67608e04 = param_1;
  DAT_67608e08 = param_1;
  DAT_67608e0c = param_1;
  return;
}



// Function: siglookup at 676034f5
...
// Function: FUN_6760352c at 6760352c

void FUN_6760352c(void)

{
  DecodePointer(DAT_67608e08);
  return;
}



// Function: _raise at 67603539
...

{
  ...
  if (_SigNum < 0xc) {
    if (_SigNum != 0xb) {
      ...
      if (_SigNum != 4) {
        if (_SigNum == 6) goto LAB_676035c1;
        if (_SigNum != 8) goto LAB_676035af;
      }
    }
...
// Function: FUN_676036a0 at 676036a0

void FUN_676036a0(void)
...
// Function: FUN_676036dc at 676036dc

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl FUN_676036dc(undefined4 param_1)

{
  _DAT_67608e14 = param_1;
  return;
}



// Function: FUN_676036eb at 676036eb

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl FUN_676036eb(undefined4 param_1)

{
  _DAT_67608e18 = param_1;
  return;
}



// Function: FUN_676036fa at 676036fa

void __cdecl FUN_676036fa(undefined4 param_1)

{
  DAT_67608e1c = param_1;
  return;
}



// Function: __call_reportfault at 67603709
...

{
  ...
  uVar1 = DAT_67608a80 ^ (uint)&stack0xfffffffc;
  if (nDbgHookCode != -1) {
    FUN_67604cf1();
  }
...
// Function: __invoke_watson at 67603832
...
// Function: __invalid_parameter at 67603857
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)DecodePointer(DAT_67608e1c);
  if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x6760386d. Too many branches */
...
// Function: FUN_67603884 at 67603884

void FUN_67603884(void)
...
// Function: FUN_67603894 at 67603894

void __cdecl FUN_67603894(undefined4 param_1)

{
  DAT_67608e20 = param_1;
  return;
}



// Function: __callnewh at 676038a3
...

{
  ...
  pcVar1 = (code *)DecodePointer(DAT_67608e20);
  if (pcVar1 != (code *)0x0) {
    iVar2 = (*pcVar1)(_Size);
    if (iVar2 != 0) {
      return 1;
...
// Function: __onexit_nolock at 676038cb
...

{
  ...
  _Memory = (undefined4 *)DecodePointer(DAT_676098c8);
  puVar1 = (undefined4 *)DecodePointer(DAT_676098c4);
  ...
  if (sVar2 < iVar5 + 4U) {
    ...
    DAT_676098c8 = EncodePointer(pvVar4);
  }
  pvVar4 = EncodePointer(param_1);
  *puVar1 = pvVar4;
  DAT_676098c4 = EncodePointer(puVar1 + 1);
  return param_1;
}



// Function: __onexit at 676039b2
...
// Function: FUN_676039e8 at 676039e8

void FUN_676039e8(void)
...
// Function: __initp_misc_cfltcvt_tab at 67603a05
...

{
  ...
  uVar2 = 0;
  do {
    pvVar1 = EncodePointer(*(PVOID *)((int)&PTR_LAB_67608a50 + uVar2));
    *(PVOID *)((int)&PTR_LAB_67608a50 + uVar2) = pvVar1;
    uVar2 = uVar2 + 4;
  } while (uVar2 < 0x28);
  return;
}
...
// Function: __ValidateImageBase at 67603a30
...
// Function: __FindPESection at 67603a70
...
// Function: __IsNonwritableInCurrentImage at 67603ac0
...

{
  ...
  local_c = DAT_67608a80 ^ 0x676079f0;
  ExceptionList = &local_14;
  local_8 = 0;
  BVar1 = __ValidateImageBase((PBYTE)&IMAGE_DOS_HEADER_67600000);
  if (BVar1 != 0) {
    p_Var2 = __FindPESection((PBYTE)&IMAGE_DOS_HEADER_67600000,(DWORD_PTR)(pTarget + -0x67600000));
...
// Function: __GET_RTERRMSG at 67603b7c
...

{
  ...
  uVar1 = 0;
  do {
    if (param_1 == (&DAT_67606df8)[uVar1 * 2]) {
      return *(wchar_t **)(&UNK_67606dfc + uVar1 * 8);
    }
    uVar1 = uVar1 + 1;
  } while (uVar1 < 0x16);
  return (wchar_t *)0x0;
...
// Function: __NMSG_WRITE at 67603ba2
...

{
  ...
  if (pwVar1 != (wchar_t *)0x0) {
    ...
    if ((iVar2 == 1) || ((iVar2 = __set_error_mode(3), iVar2 == 0 && (DAT_67608b30 == 1)))) {
      ...
      eVar3 = _wcscpy_s((wchar_t *)&DAT_67608e28,0x314,L"Runtime Error!\n\nProgram: ");
      if (eVar3 == 0) {
        _DAT_67609062 = 0;
        DVar4 = GetModuleFileNameW((HMODULE)0x0,(LPWSTR)&DAT_67608e5a,0x104);
        if ((DVar4 != 0) ||
           (eVar3 = _wcscpy_s((wchar_t *)&DAT_67608e5a,0x2fb,L"<program name unknown>"), eVar3 == 0)
           ) {
          sVar5 = _wcslen((wchar_t *)&DAT_67608e5a);
          if (0x3c < sVar5 + 1) {
            sVar5 = _wcslen((wchar_t *)&DAT_67608e5a);
            eVar3 = _wcsncpy_s(&DAT_67608de4 + sVar5,0x2fb - ((int)(sVar5 * 2 + -0x76) >> 1),L"...",
                               3);
            if (eVar3 != 0) goto LAB_67603c67;
          }
          eVar3 = _wcscat_s((wchar_t *)&DAT_67608e28,0x314,L"\n\n");
          if ((eVar3 == 0) &&
             (eVar3 = _wcscat_s((wchar_t *)&DAT_67608e28,0x314,local_200), eVar3 == 0)) {
            ___crtMessageBoxW((LPCWSTR)&DAT_67608e28,L"Microsoft Visual C++ Runtime Library",0x12010
                             );
            goto LAB_67603d42;
          }
        }
...
// Function: __FF_MSGBANNER at 67603d51
...
// Function: _strcpy_s at 67603d8a
...

{
  ...
  while (uVar1 != 0) {
    ...
    if ((char)uVar1 == '\0') goto LAB_67603e53;
    uVar1 = (uint)puVar2 & 3;
  }
  do {
    do {
...
// Function: x_ismbbtype_l at 67603e7b
...
// Function: __ismbblead at 67603ece
...
// Function: __security_check_cookie at 67603ee6
...
// Function: __local_unwind4 at 67603f00
...

{
  ...
  iStack_18 = param_2;
  uStack_1c = param_3;
  puStack_24 = &LAB_67603f90;
  pvStack_28 = ExceptionList;
  local_20 = DAT_67608a80 ^ (uint)&pvStack_28;
...
// Function: FUN_67603fd6 at 67603fd6

void FUN_67603fd6(int param_1)
...
// Function: _EH4_CallFilterFunc at 67603ff2
...
// Function: _EH4_TransferToHandler at 67604009
...
{
  __NLG_Notify(1);
                    /* WARNING: Could not recover jumptable at 0x67604020. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)UNRECOVERED_JUMPTABLE)();
  return;
}
...
// Function: _EH4_GlobalUnwind2 at 67604022
...
{
  RtlUnwind(param_1,(PVOID)0x67604036,param_2,(PVOID)0x0);
  return;
}



// Function: _EH4_LocalUnwind at 6760403b
...
// Function: ___free_lc_time at 67604052
...
// Function: ___free_lconv_num at 676043c9
...
{
  if (param_1 != (undefined4 *)0x0) {
    if ((undefined *)*param_1 != PTR_DAT_67608a98) {
      _free((undefined *)*param_1);
    }
    if ((undefined *)param_1[1] != PTR_DAT_67608a9c) {
      _free((undefined *)param_1[1]);
    }
    if ((undefined *)param_1[2] != PTR_DAT_67608aa0) {
      _free((undefined *)param_1[2]);
    }
    if ((undefined *)param_1[0xc] != PTR_DAT_67608ac8) {
      _free((undefined *)param_1[0xc]);
    }
    if ((undefined *)param_1[0xd] != PTR_DAT_67608acc) {
...
// Function: ___free_lconv_mon at 67604432
...
{
  if (param_1 != 0) {
    if (*(undefined **)(param_1 + 0xc) != PTR_DAT_67608aa4) {
      _free(*(undefined **)(param_1 + 0xc));
    }
    if (*(undefined **)(param_1 + 0x10) != PTR_DAT_67608aa8) {
      _free(*(undefined **)(param_1 + 0x10));
    }
    if (*(undefined **)(param_1 + 0x14) != PTR_DAT_67608aac) {
      _free(*(undefined **)(param_1 + 0x14));
    }
    if (*(undefined **)(param_1 + 0x18) != PTR_DAT_67608ab0) {
      _free(*(undefined **)(param_1 + 0x18));
    }
    if (*(undefined **)(param_1 + 0x1c) != PTR_DAT_67608ab4) {
      _free(*(undefined **)(param_1 + 0x1c));
    }
    if (*(undefined **)(param_1 + 0x20) != PTR_DAT_67608ab8) {
      _free(*(undefined **)(param_1 + 0x20));
    }
    if (*(undefined **)(param_1 + 0x24) != PTR_DAT_67608abc) {
      _free(*(undefined **)(param_1 + 0x24));
    }
    if (*(undefined **)(param_1 + 0x38) != PTR_DAT_67608ad0) {
      _free(*(undefined **)(param_1 + 0x38));
    }
    if (*(undefined **)(param_1 + 0x3c) != PTR_DAT_67608ad4) {
      _free(*(undefined **)(param_1 + 0x3c));
    }
    if (*(undefined **)(param_1 + 0x40) != PTR_DAT_67608ad8) {
      _free(*(undefined **)(param_1 + 0x40));
    }
    if (*(undefined **)(param_1 + 0x44) != PTR_DAT_67608adc) {
      _free(*(undefined **)(param_1 + 0x44));
    }
    if (*(undefined **)(param_1 + 0x48) != PTR_DAT_67608ae0) {
      _free(*(undefined **)(param_1 + 0x48));
    }
    if (*(undefined **)(param_1 + 0x4c) != PTR_DAT_67608ae4) {
...

{
  ...
  uVar1 = _Val & 0xff;
  if ((((char)_Val == '\0') && (0x7f < _Size)) && (DAT_67609794 != 0)) {
...
// Function: __crtLCMapStringA_stat at 676045ca
...

{
  ...
  uVar2 = DAT_67608a80 ^ (uint)&stack0xfffffffc;
  pcVar3 = param_4;
  iVar7 = param_5;
  if (0 < param_5) {
    do {
      iVar7 = iVar7 + -1;
      if (*pcVar3 == '\0') goto LAB_676045fa;
      pcVar3 = pcVar3 + 1;
    } while (iVar7 != 0);
    iVar7 = -1;
LAB_676045fa:
  ...
  cchWideChar = MultiByteToWideChar(param_8,(uint)(param_9 != 0) * 8 + 1,param_4,param_5,(LPWSTR)0x0
                                    ,0);
  if (cchWideChar == 0) goto LAB_6760479f;
...
LAB_6760468a:
  ...
  if (local_10 == (LPCWSTR)0x0) goto LAB_6760479f;
  ...
  if ((iVar7 != 0) &&
    ...
    if ((param_3 & 0x400) == 0) {
      if (((int)uVar5 < 1) || (0xffffffe0 / uVar5 < 2)) {
        ...
        _Size = uVar5 * 2 + 8;
        if (_Size < 0x401) {
          if (&stack0x00000000 == (undefined1 *)0x20) goto LAB_67604793;
...
// Function: ___crtLCMapStringA at 676047b1
...
// Function: __crtGetStringTypeA_stat at 676047f7
...

{
  ...
  cchWideChar = MultiByteToWideChar(param_6,(uint)(param_7 != 0) * 8 + 1,param_3,param_4,(LPWSTR)0x0
                                    ,0);
  if (cchWideChar == 0) goto LAB_676048cc;
...
// Function: ___crtGetStringTypeA at 676048de
...

{
  ...
  SVar2 = HeapSize(DAT_67608c88,0,_Memory);
  return SVar2;
}



// Function: _abort at 67604951
...
// Function: FID_conflict:_memcpy at 67604990
...

{
  ...
  if ((_Src < _Dst) && (_Dst < (void *)(_Size + (int)_Src))) {
    ...
    if (((uint)puVar4 & 3) == 0) {
      ...
      if (7 < uVar2) {
        ...
        case 0:
          return _Dst;
        case 2:
          goto switchD_67604b6f_caseD_2;
        case 3:
          goto switchD_67604b6f_caseD_3;
        }
        goto switchD_67604b6f_caseD_1;
      }
    }
    else {
      switch(_Size) {
      case 0:
        goto switchD_67604b6f_caseD_0;
      case 1:
        goto switchD_67604b6f_caseD_1;
      case 2:
        goto switchD_67604b6f_caseD_2;
    ...
    switch(uVar3) {
    case 1:
switchD_67604b6f_caseD_1:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar1 + 3);
      return _Dst;
    case 2:
switchD_67604b6f_caseD_2:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar1 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar1 + 2);
      return _Dst;
    case 3:
switchD_67604b6f_caseD_3:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar1 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar1 + 2);
      *(undefined1 *)((int)puVar4 + 1) = *(undefined1 *)((int)puVar1 + 1);
      return _Dst;
    }
switchD_67604b6f_caseD_0:
    return _Dst;
  }
  if (((0x7f < _Size) && (DAT_67609794 != 0)) && (((uint)_Dst & 0xf) == ((uint)_Src & 0xf))) {
    puVar1 = FUN_676053bc(_Size);
    return puVar1;
  }
  ...
  if (((uint)_Dst & 3) == 0) {
    ...
    if (7 < uVar2) {
      ...
      case 0:
        return _Dst;
      case 2:
        goto switchD_676049e9_caseD_2;
      case 3:
        goto switchD_676049e9_caseD_3;
      }
      goto switchD_676049e9_caseD_1;
    }
  }
  else {
    switch(_Size) {
    case 0:
      goto switchD_676049e9_caseD_0;
    case 1:
      goto switchD_676049e9_caseD_1;
    case 2:
      goto switchD_676049e9_caseD_2;
  ...
  switch(uVar3) {
  case 1:
switchD_676049e9_caseD_1:
                    /* WARNING: Load size is inaccurate */
    *(undefined1 *)puVar1 = *_Src;
    return _Dst;
  case 2:
switchD_676049e9_caseD_2:
                    /* WARNING: Load size is inaccurate */
    *(undefined1 *)puVar1 = *_Src;
    *(undefined1 *)((int)puVar1 + 1) = *(undefined1 *)((int)_Src + 1);
    return _Dst;
  case 3:
switchD_676049e9_caseD_3:
                    /* WARNING: Load size is inaccurate */
    *(undefined1 *)puVar1 = *_Src;
    *(undefined1 *)((int)puVar1 + 1) = *(undefined1 *)((int)_Src + 1);
...
switchD_676049e9_caseD_0:
  return _Dst;
}



// Function: FUN_67604cf1 at 67604cf1

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_67604cf1(void)
...
// Function: ___crtMessageBoxW at 67604d02
...

{
  ...
  local_24 = _LpText;
  local_20 = _LpCaption;
  local_1c = (PVOID)FUN_67601285();
  local_18 = 0;
  if (DAT_6760945c == (PVOID)0x0) {
    hModule = LoadLibraryW(L"USER32.DLL");
    if ((hModule == (HMODULE)0x0) ||
       (pFVar1 = GetProcAddress(hModule,"MessageBoxW"), pFVar1 == (FARPROC)0x0)) goto LAB_67604e5f;
    DAT_6760945c = EncodePointer(pFVar1);
    pFVar1 = GetProcAddress(hModule,"GetActiveWindow");
    DAT_67609460 = EncodePointer(pFVar1);
    pFVar1 = GetProcAddress(hModule,"GetLastActivePopup");
    DAT_67609464 = EncodePointer(pFVar1);
    pFVar1 = GetProcAddress(hModule,"GetUserObjectInformationW");
    DAT_6760946c = EncodePointer(pFVar1);
    if (DAT_6760946c != (PVOID)0x0) {
      pFVar1 = GetProcAddress(hModule,"GetProcessWindowStation");
      DAT_67609468 = EncodePointer(pFVar1);
    }
  }
  if ((DAT_67609468 == local_1c) || (DAT_6760946c == local_1c)) {
LAB_67604e0e:
    if ((((DAT_67609460 != local_1c) &&
         (pcVar2 = (code *)DecodePointer(DAT_67609460), pcVar2 != (code *)0x0)) &&
        (local_18 = (*pcVar2)(), local_18 != 0)) &&
       ((DAT_67609464 != local_1c &&
        (pcVar2 = (code *)DecodePointer(DAT_67609464), pcVar2 != (code *)0x0)))) {
      local_18 = (*pcVar2)(local_18);
    }
  }
  else {
    pcVar2 = (code *)DecodePointer(DAT_67609468);
    pcVar3 = (code *)DecodePointer(DAT_6760946c);
  ...
  pcVar2 = (code *)DecodePointer(DAT_6760945c);
  if (pcVar2 != (code *)0x0) {
...
// Function: _wcscat_s at 67604e6e
...
// Function: _wcsncpy_s at 67604ee3
...
LAB_67604f09:
  ...
  else if (_Dst != (wchar_t *)0x0) goto LAB_67604f09;
  piVar2 = __errno();
  eStack_14 = 0x16;
  *piVar2 = 0x16;
LAB_67604f1a:
...
// Function: _wcscpy_s at 67604fcb
...
// Function: __set_error_mode at 6760502e
...
// Function: ___report_gsfailure at 6760506d
...

{
  ...
  _DAT_6760958c = &stack0x00000004;
  _DAT_676094c8 = 0x10001;
  _DAT_67609470 = 0xc0000409;
  _DAT_67609474 = 1;
  local_32c = DAT_67608a80;
  local_328 = DAT_67608a84;
  _DAT_6760947c = unaff_retaddr;
  _DAT_67609554 = in_GS;
  _DAT_67609558 = in_FS;
  _DAT_6760955c = in_ES;
  _DAT_67609560 = in_DS;
  _DAT_67609564 = unaff_EDI;
  _DAT_67609568 = unaff_ESI;
  _DAT_6760956c = unaff_EBX;
  _DAT_67609570 = in_EDX;
  _DAT_67609574 = in_ECX;
  _DAT_67609578 = in_EAX;
  _DAT_6760957c = unaff_EBP;
  DAT_67609580 = unaff_retaddr;
  _DAT_67609584 = in_CS;
  _DAT_67609590 = in_SS;
  DAT_676094c0 = IsDebuggerPresent();
  FUN_67604cf1();
  SetUnhandledExceptionFilter((LPTOP_LEVEL_EXCEPTION_FILTER)0x0);
  UnhandledExceptionFilter((_EXCEPTION_POINTERS *)&PTR_DAT_676077ec);
  if (DAT_676094c0 == 0) {
    FUN_67604cf1();
  }
...
// Function: __global_unwind2 at 67605180
...
{
  RtlUnwind(param_1,(PVOID)0x67605198,(PEXCEPTION_RECORD)0x0,(PVOID)0x0);
  return;
}



// Function: __local_unwind2 at 676051e5
...
// Function: __NLG_Notify at 67605295
...

{
  ...
  DAT_67608b18 = param_1;
  DAT_67608b14 = in_EAX;
  DAT_67608b1c = unaff_EBP;
  return;
}



// Function: FUN_676052b4 at 676052b4

void FUN_676052b4(void)
...
// Function: __VEC_memzero at 676052b7
...
// Function: __alloca_probe_16 at 67605390
...
// Function: __alloca_probe_8 at 676053a6
...
// Function: FUN_676053bc at 676053bc

undefined4 * __fastcall FUN_676053bc(uint param_1)
...
// Function: __alloca_probe at 676054c0
