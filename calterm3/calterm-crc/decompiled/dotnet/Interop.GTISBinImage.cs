...
namespace Cummins.Interop.CalBinImage;
...
{
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	void AddImageData([In] int lAddress, [In][ComAliasName("Cummins.Interop.CalBinImage.CIBinImageData")] CIBinImageData recImageData);
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[return: ComAliasName("Cummins.Interop.CalBinImage.CIBinImageData")]
...
public class CICalBinImageClass : ICIFile, CICalBinImage, ICIBinImage, ICIHeaderRecords, ICISymbolicInit, ICIBinaryDataList
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	public virtual extern void AddImageData([In] int lAddress, [In][ComAliasName("Cummins.Interop.CalBinImage.CIBinImageData")] CIBinImageData recImageData);
