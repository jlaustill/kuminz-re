...
namespace Cummins.Interop.CalDataServer;
...
public interface ICIRequest
{
	...
	[ComAliasName("Cummins.Interop.CalDataServer.ReqProtocolEnum")]
	[DispId(3)]
	ReqProtocolEnum ReqProtocol
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(3)]
		[return: ComAliasName("Cummins.Interop.CalDataServer.ReqProtocolEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(3)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.CalDataServer.ReqProtocolEnum")]
		set;
	}

	[DispId(4)]
	[ComAliasName("Cummins.Interop.CalDataServer.RequestTypeEnum")]
	RequestTypeEnum ReqType
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[return: ComAliasName("Cummins.Interop.CalDataServer.RequestTypeEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.CalDataServer.RequestTypeEnum")]
		set;
	}

	[ComAliasName("Cummins.Interop.CalDataServer.RequestStatusEnum")]
	[DispId(5)]
	RequestStatusEnum ReqStatus
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(5)]
		[return: ComAliasName("Cummins.Interop.CalDataServer.RequestStatusEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(5)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.CalDataServer.RequestStatusEnum")]
		set;
	}
...
[ComImport]
[ClassInterface(0)]
[ComSourceInterfaces("Cummins.Interop.CalDataServer._ICICalOperationResponseEvent\0Cummins.Interop.CalDataServer._ICICalFinalResponseEvent\0\0")]
