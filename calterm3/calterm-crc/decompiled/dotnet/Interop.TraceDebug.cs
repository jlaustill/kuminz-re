...
namespace Cummins.Interop.TraceDebug;
...
public interface ICILog
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(1)]
	void LogMessage([In][MarshalAs(UnmanagedType.BStr)] string programmerText, [In][ComAliasName("Cummins.Interop.TraceDebug.CILogLevels")] CILogLevels Level, [In] int Categories, [In][MarshalAs(UnmanagedType.BStr)] string fileName, [In] int lineNumber, [In] int thread = 0);
}
[ComImport]
[ClassInterface(0)]
...
public class LoggerClass : ICILog, Logger, ICILogManager
{
	...
	[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
	[DispId(1)]
	public virtual extern void LogMessage([In][MarshalAs(UnmanagedType.BStr)] string programmerText, [In][ComAliasName("Cummins.Interop.TraceDebug.CILogLevels")] CILogLevels Level, [In] int Categories, [In][MarshalAs(UnmanagedType.BStr)] string fileName, [In] int lineNumber, [In] int thread = 0);
