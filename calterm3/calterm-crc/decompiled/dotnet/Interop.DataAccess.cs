...
namespace Cummins.Interop.DataAccess;
...
public interface ICIRequest
{
	...
	[DispId(3)]
	[ComAliasName("Cummins.Interop.DataAccess.ReqProtocolEnum")]
	ReqProtocolEnum ReqProtocol
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(3)]
		[return: ComAliasName("Cummins.Interop.DataAccess.ReqProtocolEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(3)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.DataAccess.ReqProtocolEnum")]
		set;
	}

	[DispId(4)]
	[ComAliasName("Cummins.Interop.DataAccess.RequestTypeEnum")]
	RequestTypeEnum ReqType
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[return: ComAliasName("Cummins.Interop.DataAccess.RequestTypeEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.DataAccess.RequestTypeEnum")]
		set;
	}

	[DispId(5)]
	[ComAliasName("Cummins.Interop.DataAccess.RequestStatusEnum")]
	RequestStatusEnum ReqStatus
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(5)]
		[return: ComAliasName("Cummins.Interop.DataAccess.RequestStatusEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(5)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.DataAccess.RequestStatusEnum")]
		set;
	}
