...
namespace Cummins.Interop.CUDL;
...
public enum CUDLMsgEnum
{
	...
	MSG_DIAG_ASSNR_COMPLETED = 287,
	MSG_DIAG_ASSNR_ERROR = 288,
	MSG_DIAG_ASSNR_PARAM_READ_ERROR = 289,
	MSG_DIAG_NOT_COMPATIBLE_BYTE_ORDER = 290
}
...
[ComImport]
[ClassInterface(0)]
[ComSourceInterfaces("Cummins.Interop.CUDL._ICICUDLSaveRestoreEvents\0\0")]
[TypeLibType(2)]
...
public class CUDLSaveRestoreClass : ICICUDLSaveRestore, CUDLSaveRestore, _ICICUDLSaveRestoreEvents_Event
{
	...
	[DispId(4)]
	[ComAliasName("Cummins.Interop.CUDL.ErrorCodeEnum")]
	public virtual extern ErrorCodeEnum ErrorCode
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[return: ComAliasName("Cummins.Interop.CUDL.ErrorCodeEnum")]
		get;
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		[DispId(4)]
		[param: In]
		[param: ComAliasName("Cummins.Interop.CUDL.ErrorCodeEnum")]
		set;
	}
